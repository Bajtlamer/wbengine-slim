...
CREATE TABLE `cms_articles` (
  ...
  KEY `views` (`views`),
  KEY `title` (`title`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `cms_boxes` (
  ...
  `location` varchar(255) COLLATE utf8_czech_ci NOT NULL DEFAULT '',
  ...
  KEY `static` (`static`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci ROW_FORMAT=DYNAMIC COMMENT='Boxes list';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cms_boxes` VALUES (1,'Home','story','front',1,0,0,'app',1,0),(2,'About static page','articles','about',1,1,0,'app',1,0),(3,'Blogs','story','story',1,1,0,'app',1,0),(4,'Jumbotron','jumbotron','jumbotron',4,0,0,'app',1,0);
/*!40000 ALTER TABLE `cms_boxes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cms_boxorders`
--

DROP TABLE IF EXISTS `cms_boxorders`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cms_boxorders` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  KEY `box_id` (`box_id`),
  KEY `order` (`order`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cms_boxorders`
--

LOCK TABLES `cms_boxorders` WRITE;
/*!40000 ALTER TABLE `cms_boxorders` DISABLE KEYS */;
INSERT INTO `cms_boxorders` VALUES (1,1,4,0),(2,2,2,0),(3,3,3,0);
/*!40000 ALTER TABLE `cms_boxorders` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cms_menu` (
  ...
  KEY `type` (`type`),
  KEY `visible` (`visible`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cms_menu` VALUES (1,2,1,'About','Example of static webpage',1,2,0),(2,3,1,'Example Blog','Example blog website',1,1,0);
...
INSERT INTO `cms_sections` VALUES (1,'Central section','The central section',1,'central',404),(2,'Right panel','Right webpage Panel',0,'right',404),(3,'Left panel','The left webpage panel',0,'left',404),(4,'Header','The section above Central box',1,'header',404);
...
CREATE TABLE `cms_sessions` (
  ...
  KEY `user_ip` (`user_ip`)
) ENGINE=InnoDB AUTO_INCREMENT=3317 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Sessions table';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cms_sessions` VALUES (3316,1,'qtthet6timdgim72qhpt8cg6d3','a:3:{s:7:\"user_id\";i:1;s:14:\"user_is_logged\";b:0;s:11:\"user_locale\";i:1;}','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.133 Safari/537.36','192.168.11.141',1492095213,1492098813,'1112e7da2c');
...
INSERT INTO `cms_sites` VALUES (1,1,1,0,1,1,'/','Welcome to wbengine skeleton application','Welcome to wbengine skeleton application','Welcome to wbengine skeleton application','welcome,rrsoft,skeleton,application'),(2,1,4,5,1,1,'/about/','About Weengine','About Weengine','Web Box Engine Skeleton template application','rrsoft,wbegine,skeleton'),(3,1,6,7,1,1,'/blogs/','Blog Example','Blog Example','WBengine - Wxample blog website','blog,wbengine');
/*!40000 ALTER TABLE `cms_sites` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cms_sitetype`
--

DROP TABLE IF EXISTS `cms_sitetype`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cms_sitetype` (
...
--
-- Dumping data for table `cms_sitetype`
--

LOCK TABLES `cms_sitetype` WRITE;
/*!40000 ALTER TABLE `cms_sitetype` DISABLE KEYS */;
INSERT INTO `cms_sitetype` VALUES (1,'Frontend','Front',1),(2,'Backend','Admin',NULL);
/*!40000 ALTER TABLE `cms_sitetype` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cms_submenu` (
  ...
  KEY `parent` (`parent`),
  KEY `locale` (`locale`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci ROW_FORMAT=DYNAMIC;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cms_users` (
  ...
  `ac_status` int(10) unsigned DEFAULT NULL,
  ...
  `post` varchar(45) COLLATE utf8_czech_ci DEFAULT NULL,
...
INSERT INTO `cms_users` VALUES (1,0,1,'ANONYMOUS','Anonymní','Uživatel','0',NULL,0,0,NULL,NULL,NULL,NULL,NULL,0,0,NULL,1);
...
-- Dump completed on 2017-04-13 17:09:06